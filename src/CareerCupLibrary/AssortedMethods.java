...
public class AssortedMethods {
	public static void main(String[] args) {
		// System.out.println(AssortedMethods.randomInt(100));
		// System.out.println(AssortedMethods.randomIntInRange(10, 20));
		// System.out.println(AssortedMethods.randomMatrix(2, 3, 1, 20));
		//System.out.println(AssortedMethods.randomArray(10, 1, 20));
		///System.out.println(AssortedMethods.randomArray(10, 1, 20));
		//AssortedMethods.randomLinkedList(10, 1, 10);
		//AssortedMethods.printMatrix(AssortedMethods.randomMatrix(2, 3, 1, 20));
		AssortedMethods.createTreeFromArray(randomArray(11, 2, 10));
	}
